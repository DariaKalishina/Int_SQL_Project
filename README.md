...
2. **Cohort Analysis:** Ho do different customer groups generate revenue?
3. **Retention Analysis:** Who hasn't purchased recently?

## Analysis Approach

### 1. Customer Segmentation Analysis
- Categorized customers based on total lifetime values(LTV)
...
- Predicted & preempt churn risk and use customer-specific warning indicators to proactively intervene with at-risk users before the lapse.

## Strategic Recommendations

1. **Customer Value Optimization** (Customer Segmentation)
- Launch VIP program for 12,372 high-value (66% revenue)
- Create personalized upgrade path for mid-value segment ($66.6M - $135.4M opportunity)
